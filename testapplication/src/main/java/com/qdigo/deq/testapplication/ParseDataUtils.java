...
//        parseSpeed(data);
     ...
     * @return
     */
    public static String parseSpeed(Context mContext, int[] data){
        //霍尔计数
...
//        int p = 23;
        float speed = (float) ((hallCount*7200*circumference*Math.PI)/(6*p));
    ...
    public static int getLow4(byte data){//获取低四位
     ...
     public static void main(String [] arg){
        int[] data={0x24,0x04,0x0f,0x10,0x78,0x1a,0x00,0x9e,0x01,0x00,0x11,0x00,0x00,0x89};
         System.out.print(parseSpeed(null,data));
     }
}

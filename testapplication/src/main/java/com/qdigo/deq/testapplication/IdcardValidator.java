...
public class IdcardValidator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String idcard18 = "13042519880325662X";//23060019851223636x 45100119860509137X
        // 15位身份证
//        System.out.println(isValidatedAllIdcard(idcard15));
        // 18位身份证
        System.out.println(isValidatedAllIdcard(idcard18));
        System.out.println(isValidatedAllIdcard("23060019851223636x"));
        System.out.println(isValidatedAllIdcard("45100119860509137X"));
        System.out.println(isValidatedAllIdcard("130321860311519"));
        System.out.println(isValidatedAllIdcard("340322199203157870"));
        // 15位身份证转18位身份证

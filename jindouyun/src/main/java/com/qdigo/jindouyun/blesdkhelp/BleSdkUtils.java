...
public class BleSdkUtils {
    ...
    private static BleSdkUtils mBleSdkUtils;
    public static BleSdkUtils getInstance(){
        return mBleSdkUtils == null ? mBleSdkUtils = new BleSdkUtils() : mBleSdkUtils;
    }
    ...
    public SmartBikeServerConnection getConnection(){
        return mConnection;
    }
    ...
    public boolean bindService(Activity activity, ServerConnectListerner mServerConnectListerner) {
        ...
        Log.w(TAG, "bind service result = " + connect +" , mConnection = "+mConnection);
        return connect;
    }
    ...
    public void unBindService() {
        ...
        Log.w(TAG, "unbind service"+" , mConnection = "+mConnection);
    }
...
//            connectDevice();
    ...
    public boolean isSmartBikeAvailable() {
        ...
        Log.w(TAG, "isSmartBikeAvailable connect=" + connect +" , mSmartBike = "+mSmartBike);
        return connect;
    }
    ...
    public boolean isScanning() {
        ...
        Log.w(TAG, "isScanning :" + scanIsRunning+" , mSmartBikeManager = "+mSmartBikeManager);
...
//            mSmartBikeManager.setContext(mContext);
    ...
    private class SmartBikeDelegate extends SmartBike.Delegate {
        ...
        public void smartBikeUpdateData(SmartBike smartBike, byte[] data) {
            ...
            mSmartBikeListerner.smartBikeUpdateData(smartBike, data);
        }
    }
    ...
    public interface SmartBikeListerner {
        ...
        void smartBikeUpdateData(SmartBike smartBike, byte[] data);
    }

    private SmartBikeListerner mSmartBikeListerner;

    public void setSmartBikeListerner(SmartBikeListerner smartBikeListerner) {

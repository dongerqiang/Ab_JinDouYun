...
public abstract class AbstractWheelTextAdapter extends AbstractWheelAdapter {
	...
	/** Default text color */
	public static final int DEFAULT_TEXT_COLOR = 0x250920;
	...
	public void setCenId(int textColor) {
		this.cenId = textColor;
...
/*				if(cenId == index){
					...
					textView.setTextColor(context.getResources().getColor(R.color.left_history_color));
				}
*/			}
			return convertView;
		}
...
//		Typeface typeface = Typeface.createFromAsset(context.getResources().getAssets(), "fonts/FZZDXJT.TTF");
//		view.setTypeface(typeface);
	...
	private View getView(int resource, ViewGroup parent) {
		...
		default:
			...
			TextView tv1  = (TextView) view.findViewById(itemTextResourceId);
			tv1.setTextSize(16);
			return view;
		}
	}
